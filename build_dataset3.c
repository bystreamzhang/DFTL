// IO_NUM_WRITES 500000000ULL (5亿写入)
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <time.h>

#define IO_NUM_WRITES 500000000ULL
...
// 哈希表参数（按需调小以适配内存）
#define BUCKET_COUNT 2147483648U
#define NODE_CAPACITY 1280000000U // 节点池容量
...
int main() {
    ...
    FILE *trace = fopen("trace2.txt", "w");
    FILE *readout = fopen("read_result2.txt", "w");
    if (!trace || !readout) {
